   ...
   Scanner scanner = new Scanner(System.in);
    ...
    public void printSummary () {
        System.out.println( "\nHAIL, MIGHTY HAMMURABI, CHOSEN SHEPHERD OF SUMER!\n" +
                            ...
                            "Kris and Paul have smiled upon thee! " + this.journeyed + " souls have journeyed from distant lands to dwell beneath thy benevolent rule.\n\n" +
                            "Thy flock now numbers " + this.flock + " SOULS, entrusted to thy wisdom and care.\n\n" +
                            "By the grace of Raz, God of Agriculture, thy fields have yielded " + this.harvested + " BUSHELS from the earth, blessed with " + this.grainPerAcre + " bushels per acre!\n\n" +
                            "Alas! The cursed clankers, spawn of darkness, have devoured " + this.clankersAte + " BUSHELS from thy stores, leaving " + this.storedBushels + " BUSHELS in the Royal Storehouse.\n\n" +
                            "Thy dominion encompasses " + this.acresOwned + " ACRES of fertile land.\n\n" +
                            "The merchants in the marketplace decree that each acre may be bought or sold for " + this.landPrice + " BUSHELS of grain in this season.\n\n" +
                            "---\n\n" +
